...
c ------------------------------------------------------------------------------
m81 1001    -0.01        6000    -0.001       8016    -0.52        11023   -0.02        12024   -0.002       13027   -0.034       14028   -0.34       
m82 1001    -0.01        6000    -0.001       8016    -0.52        11023   -0.02        12024   -0.002       13027   -0.034       14028   -0.34        19039   -0.013       20040   -0.044       26056   -0.014      
c ==============================================================================
c ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
c |||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| type ||
c ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
f4:n 1"""
    ...
    correct_physics_block = text_block.strip().split('\n')
